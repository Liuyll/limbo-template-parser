...
function parse(source) {
    ...
    const readComment = () => {
        ...
        if (!comment) {
            (0, error_1.errors)(error_1.Errors.CommentNotMatchEnd, { line, column });
        }
        return comment;
    };
    /**
    ...
    const readTag = (sibling) => {
        ...
        const flushAttr = () => {
            ...
            if (readyResolveValue && !valueStart && !valueEnd) {
                ...
                (0, error_1.errors)(error_1.Errors.LackPropertyValue, { attr: name, line, column });
            }
            let value;
            if (!valueStart)
                value = true;
        ...
        while (true) {
            ...
            if (index === source.length)
                (0, error_1.errors)(error_1.Errors.ResolveOverflowLength);
            if (char === '\n' || (char === '\r' && peep(1) === '\n')) {
                if (commentsStart) {
                    commentsStart = false;
                    continue;
            ...
            if (char === 'l' && peep(1) === '-') {
                ...
                if (maybeDirectiveStr in innerDirectiveLists) {
                    ...
                    if (maybeDirectiveStr === 'l-else' || maybeDirectiveStr === 'l-elif' && (sibling && !sibling.condition)) {
                        console.log(sibling);
                        (0, error_1.errors)(error_1.Errors.UnexpectedConditionDirective, { condition: maybeDirectiveStr, line, column });
                    }
            ...
            // eg: l-key="value"
                ...
                (0, error_1.errors)(error_1.Errors.UnexpectedChar, { column, line, char });
            }
            else if (char === '}') {
                (0, error_1.errors)(error_1.Errors.UnexpectedChar, { column, line, char });
            }
        ...
        while (index < source.length) {
            ...
            if (char === '<') {
                ...
                // close
                    ...
                    if (tag !== parent.tag) {
                        (0, error_1.errors)(error_1.Errors.UnexpectedTagClose, { line, column, tag, correct: parent.tag });
                    }
                    return;
                }
            ...
            if (char === '}') {
                if (!binding)
                    (0, error_1.errors)(error_1.Errors.UnexpectedRightBrace, { line, column });
                binding--;
                if (!binding)
                    flushText();
                else
            ...
            if (!textNode && ((_c = (_b = parent === null || parent === void 0 ? void 0 : parent.children) === null || _b === void 0 ? void 0 : _b.slice(-1)[0]) === null || _c === void 0 ? void 0 : _c.condition) && (char === ' ' || char === '\n' || char === '\r\n')) {
                continue;
            }
            if (!textNode) {
                textNode = {
